	...
	<div class="container">
		<div class="row">
			...
			<div class="col-lg-6 col-md-8 login-box">
				...
				<%
				String registrationsms = (String) session.getAttribute("reg-success");
				if (registrationsms != null) {
				%>

				<div class="successbox success-sms"><%=registrationsms%>Login <a
				...
				<%
				String failedsms = (String) session.getAttribute("failed-message");
				if (failedsms != null) {
				%>

				<div class="alert alert-warning" role="alert"><%=failedsms%></div>
